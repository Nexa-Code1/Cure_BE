...
export const reserveDoctor = async (req, res) => {
  try {
    ...
    doctor.setDataValue("available_slots", availableSlots);
    doctor.changed("available_slots", true);
    await doctor.save();
...
export const updateBooking = async (req, res) => {
  try {
    ...
    booking.setDataValue("day", newDay);
    booking.setDataValue("slot", newSlot);
    booking.setDataValue("status", "upcoming");
    await booking.save();
...
export const completeBooking = async (req, res) => {
  try {
    ...
    booking.setDataValue("status", "completed");
    await booking.save();
