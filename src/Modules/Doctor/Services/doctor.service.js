...
const doctors = JSON.parse(
  fs.readFileSync(join(__dirname, "doctors.json"), "utf-8")
);
      ...
      include: [
        {
          model: ReviewModel,
          as: "reviews",
          attributes: ["id", "rate", "comment", "created_at", "updated_at"],
          include: [
            {
              model: UserModel,
              as: "user",
...
// export const addDoctorsFromArray = async (req, res) => {
//   try {
//     const createdDoctors = await DoctorModel.bulkCreate(doctors, {
//       validate: true,
